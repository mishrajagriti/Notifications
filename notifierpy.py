...
# Label - Title
t_label = Label(t, text="Title to Notify",font=("poppins", 10),bg="#528DFF",fg="#ffffff")
...
# Label - Message
m_label = Label(t, text="Display Message", font=("poppins", 10),bg="#528DFF",fg="#ffffff")
...
# Label - Time
time_label = Label(t, text="Set Time", font=("poppins", 10),bg="#528DFF",fg="#ffffff")
...
# Label - min
time_min_label = Label(t, text="min", font=("poppins", 10),bg="#528DFF",fg="#ffffff")
